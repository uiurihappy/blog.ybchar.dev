...
import com.ybcharlog.exception.NotAuthorizedException;
import com.ybcharlog.exception.SignInException;
...
public class TokenService {
    ...
    public static Map<String, Object> generateDefaultClaims(User user, Long plusExpMinutes) {
        ...
        claims.put("userRoles", user.rolesToString());
        claims.put("created",
    ...
    public static Map<String, Object> generateReFreshClaims(User user, Long plusExpMinutes) {
        LocalDateTime now = LocalDateTime.now();
    ...
    public static String generateRefreshToken(User user, Boolean remember) {
    ...
    public static String generateToken(User user, Long plusExpMinutes) {
        Map<String, Object> claims = generateDefaultClaims(user, plusExpMinutes);

        return JwtUtil.generateToken(claims);
    }

    public static String generateRefreshToken(User user, Long plusExpMinutes) {
    ...
    public static String generateMailUserChangePasswordToken(User user, Long plusExpMinutes) {
        LocalDateTime now = LocalDateTime.now();
